...
folder are mapped to the application's root namespace, 'deviceSpecificApp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'deviceSpecificApp' in the same way
as `"deviceSpecificApp/sass/src"`.
